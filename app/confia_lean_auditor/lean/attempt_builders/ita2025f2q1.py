...
STRONG_F2Q1_CLAIM = r"""
theorem generated_strong_f2q1_claim : StrongF2Q1Claim := by
  exact strong_f2q1_claim
"""
...
def build_attempt_ita2025f2q1(
    ...
    if (
        ...
        parts.append(STRONG_F2Q1_CLAIM)
        generated_theorems.append("generated_strong_f2q1_claim")
